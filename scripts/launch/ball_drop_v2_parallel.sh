...
# Varies both ball and platform restitution coefficients
# OUTPUT_DIR="/net/acadia1a/data/sriram/vidgen/datasets/kubric_generated/ball_drop_v2"
# Varies only ball restitution coefficients
OUTPUT_DIR="/net/acadia1a/data/sriram/vidgen/datasets/kubric_generated/ball_drop_v2_ball_only"
NUM_WORKERS=16
NUM_VIDEOS=2000
RESOLUTION="768x432"
FRAME_END=97
...
"$PYTHON_PATH" src/run_parallel_ball_drop_v2.py \
